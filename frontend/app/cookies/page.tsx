    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F3F1E9] via-[#ECE8D9] to-[#F3F1E9] dark:from-[#1E1E1E] dark:via-[#2A2A2A] dark:to-[#1E1E1E] transition-all duration-500">      {/* Classic Background Pattern */}
      ...
      <Navbar />      <div className="max-w-4xl sm:max-w-5xl lg:max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          ...
          <p className="text-base sm:text-lg md:text-xl text-[#5A5A5A] dark:text-[#B6B6B6] max-w-3xl mx-auto leading-relaxed animate-fade-in px-2 sm:px-4 font-serif" style={{ animationDelay: '0.2s' }}>
            Learn how Voce uses cookies to enhance your experience, analyze usage patterns, and provide personalized services while respecting your privacy preferences.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 md:gap-4 mt-4 sm:mt-5 md:mt-6 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <Badge variant="outline" className="bg-[#F3F1E9]/50 dark:bg-[#1E1E1E]/80 text-xs sm:text-sm border-[#BBA588]/40 font-serif">
        ...
        <Card className="glass-classic border-[#BBA588]/40 dark:border-[#BBA588]/20 shadow-2xl mb-8 sm:mb-10 md:mb-12 animate-fade-in" style={{ animationDelay: '0.4s' }}>
          ...
          <CardContent className="p-4 sm:p-6 pt-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <div className="text-center p-3 sm:p-4 bg-[#BBA588]/10 dark:bg-[#BBA588]/10 rounded-lg">
                ...
                <h3 className="font-semibold text-[#2D2C2A] dark:text-[#ECE8D9] mb-2 text-sm sm:text-base font-serif-display">Transparency</h3>
                <p className="text-xs sm:text-sm text-[#5A5A5A] dark:text-[#B6B6B6] font-serif">We clearly explain what cookies we use and why</p>
              </div>
              <div className="text-center p-3 sm:p-4 bg-[#8E735B]/10 dark:bg-[#8E735B]/10 rounded-lg">
                ...
                <h3 className="font-semibold text-[#2D2C2A] dark:text-[#ECE8D9] mb-2 text-sm sm:text-base font-serif-display">Control</h3>
                <p className="text-xs sm:text-sm text-[#5A5A5A] dark:text-[#B6B6B6] font-serif">You can manage your cookie preferences anytime</p>
              </div>
              <div className="text-center p-3 sm:p-4 bg-[#7C6D64]/10 dark:bg-[#7C6D64]/10 rounded-lg sm:col-span-2 lg:col-span-1">
                ...
                <h3 className="font-semibold text-[#2D2C2A] dark:text-[#ECE8D9] mb-2 text-sm sm:text-base font-serif-display">Security</h3>
                <p className="text-xs sm:text-sm text-[#5A5A5A] dark:text-[#B6B6B6] font-serif">All cookies are secured and privacy-focused</p>
              </div>
            </div>
          </CardContent>
        </Card>        {/* Cookie Categories */}
        <div className="mb-8 sm:mb-10 md:mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#2D2C2A] dark:text-[#ECE8D9] mb-6 sm:mb-8 animate-fade-in font-serif-display" style={{ animationDelay: '0.5s' }}>
            Types of Cookies We Use
          </h2>
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6">
            {cookieCategories.map((category, index) => (
              <Card key={index} className="glass-classic border-[#BBA588]/40 dark:border-[#BBA588]/20 shadow-xl hover:shadow-2xl transition-all duration-300 animate-fade-in" style={{ animationDelay: `${0.6 + index * 0.1}s` }}>
                <CardHeader className="p-4 sm:p-6">
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    ...
                    <Badge className={`${category.statusColor} text-white text-xs sm:text-sm font-serif`}>
                      {category.status}
                    </Badge>
                  </div>
                  <p className="text-[#5A5A5A] dark:text-[#B6B6B6] text-sm sm:text-base font-serif">{category.description}</p>
                </CardHeader>
                <CardContent className="p-4 sm:p-6 pt-0">
                  <div className="space-y-3">
                    {category.cookies.map((cookie, cookieIndex) => (
                      <div key={cookieIndex} className="border-l-2 border-[#BBA588]/40 dark:border-[#BBA588]/20 pl-3 sm:pl-4 py-2">
                        <div className="flex justify-between items-start gap-2">
                          <div className="min-w-0 flex-1">
                            <h4 className="font-semibold text-[#2D2C2A] dark:text-[#ECE8D9] text-sm font-serif-display">{cookie.name}</h4>
                            <p className="text-xs text-[#5A5A5A] dark:text-[#B6B6B6] break-words font-serif">{cookie.purpose}</p>
                          </div>
                          <Badge variant="outline" className="text-xs shrink-0 border-[#BBA588]/40 font-serif">
                            {cookie.duration}
                          </Badge>
                        </div>
                      </div>
        ...
        <Card className="glass-classic border-[#BBA588]/40 dark:border-[#BBA588]/20 shadow-2xl mb-8 sm:mb-10 md:mb-12 animate-fade-in" style={{ animationDelay: '1s' }}>
          <CardHeader className="p-4 sm:p-6">
            <CardTitle className="flex items-center space-x-2 text-[#2D2C2A] dark:text-[#ECE8D9] text-lg sm:text-xl font-serif-display">
          ...
          <CardContent className="p-4 sm:p-6 pt-0">
            <div className="space-y-4 sm:space-y-6">
              {thirdPartyServices.map((service, index) => (
                <div key={index} className="border border-[#BBA588]/30 dark:border-[#BBA588]/20 rounded-lg p-3 sm:p-4">
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 sm:gap-3 mb-3">
                    <h3 className="font-semibold text-[#2D2C2A] dark:text-[#ECE8D9] text-base sm:text-lg font-serif-display">{service.name}</h3>
                    <Link
        ...
        <Card className="glass-classic border-[#BBA588]/40 dark:border-[#BBA588]/20 shadow-2xl mb-8 sm:mb-10 md:mb-12 animate-fade-in" style={{ animationDelay: '1.1s' }}>
          <CardHeader className="p-4 sm:p-6">
            <CardTitle className="flex items-center space-x-2 text-[#2D2C2A] dark:text-[#ECE8D9] text-lg sm:text-xl font-serif-display">
          ...
          <CardContent className="p-4 sm:p-6 pt-0">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              <div>
                <h3 className="font-semibold text-[#2D2C2A] dark:text-[#ECE8D9] mb-3 text-base sm:text-lg font-serif-display">Browser Settings</h3>
                ...
                <ul className="space-y-2 text-sm text-[#5A5A5A] dark:text-[#B6B6B6] font-serif">
                  <li className="flex items-center space-x-2">
                    <CheckCircle className="h-4 w-4 text-[#8E735B] shrink-0" />
              ...
              <div>
                <h3 className="font-semibold text-[#2D2C2A] dark:text-[#ECE8D9] mb-3 text-base sm:text-lg font-serif-display">Our Cookie Consent</h3>
                <p className="text-[#5A5A5A] dark:text-[#B6B6B6] text-sm mb-4 font-serif">
                ...
                <div className="space-y-3">
                  ...
                  <Button variant="outline" className="w-full btn-classic-outline text-sm sm:text-base font-serif-display">
        ...
        <Card className="glass-classic border-[#BBA588]/40 dark:border-[#BBA588]/20 shadow-2xl mb-8 sm:mb-10 md:mb-12 animate-fade-in" style={{ animationDelay: '1.2s' }}>
          <CardHeader className="p-4 sm:p-6">
            <CardTitle className="flex items-center space-x-2 text-[#2D2C2A] dark:text-[#ECE8D9] text-lg sm:text-xl font-serif-display">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          <Card className="glass-classic border-[#BBA588]/40 dark:border-[#BBA588]/20 shadow-xl animate-fade-in" style={{ animationDelay: '1.3s' }}>
            <CardHeader className="p-4 sm:p-6">
              <CardTitle className="text-[#2D2C2A] dark:text-[#ECE8D9] text-lg sm:text-xl font-serif-display">Questions About Cookies?</CardTitle>
            </CardHeader>
            <CardContent className="p-4 sm:p-6 pt-0">
          ...
          <Card className="glass-classic border-[#BBA588]/40 dark:border-[#BBA588]/20 shadow-xl animate-fade-in" style={{ animationDelay: '1.4s' }}>
            <CardHeader className="p-4 sm:p-6">
              <CardTitle className="text-[#2D2C2A] dark:text-[#ECE8D9] text-lg sm:text-xl font-serif-display">Policy Updates</CardTitle>
            </CardHeader>
            <CardContent className="p-4 sm:p-6 pt-0">
              <p className="text-[#5A5A5A] dark:text-[#B6B6B6] mb-4 text-sm sm:text-base font-serif">
