    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-blue-50 to-cyan-50 dark:from-slate-950 dark:via-blue-950 dark:to-violet-950 transition-all duration-500">      {/* Enhanced Background Pattern */}
      ...
      <Navbar />      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 relative z-10">
        ...
        <div className="text-center mb-12 lg:mb-16">
          <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-blue-500 to-violet-600 rounded-full mb-4 sm:mb-6 shadow-lg animate-pulse">
            <Scale className="h-6 w-6 sm:h-8 sm:w-8 text-white" />
          </div>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white mb-4 sm:mb-6 animate-fade-in px-2">
            GDPR Compliance
          </h1>
          <p className="text-lg sm:text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed animate-fade-in px-4" style={{animationDelay: '0.2s'}}>
            Your privacy rights matter to us. Learn how SalesSpeak complies with the General Data Protection Regulation (GDPR) and how you can exercise your data protection rights.
          </p>
        ...
        <Card className="glass-strong border-white/30 dark:border-slate-700/50 shadow-2xl mb-8 sm:mb-12 animate-fade-in" style={{animationDelay: '0.4s'}}>
          ...
          <CardContent className="p-4 sm:p-6 pt-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <div className="text-center p-3 sm:p-4 bg-blue-50/50 dark:bg-blue-900/20 rounded-lg">
                ...
                <h3 className="font-semibold text-slate-900 dark:text-white mb-2 text-sm sm:text-base">Individual Rights</h3>
                <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300">Enhanced control over personal data</p>
              </div>
              <div className="text-center p-3 sm:p-4 bg-green-50/50 dark:bg-green-900/20 rounded-lg">
                ...
                <h3 className="font-semibold text-slate-900 dark:text-white mb-2 text-sm sm:text-base">Data Protection</h3>
                <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300">Stronger security and privacy measures</p>
              </div>
              <div className="text-center p-3 sm:p-4 bg-purple-50/50 dark:bg-purple-900/20 rounded-lg sm:col-span-2 lg:col-span-1">
                <Scale className="h-6 w-6 sm:h-8 sm:w-8 text-purple-600 mx-auto mb-2" />
                <h3 className="font-semibold text-slate-900 dark:text-white mb-2 text-sm sm:text-base">Accountability</h3>
                <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300">Organizations must demonstrate compliance</p>
              </div>
            </div>
          </CardContent>
        </Card>        {/* Your Data Rights */}
        <div className="mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white mb-6 sm:mb-8 animate-fade-in px-2" style={{animationDelay: '0.5s'}}>
            Your Data Protection Rights
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
            {dataRights.map((right, index) => (
              <Card key={index} className="glass-strong border-white/30 dark:border-slate-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] animate-fade-in" style={{animationDelay: `${0.6 + index * 0.1}s`}}>
                <CardHeader className="p-4 sm:p-6">
                  <div className={`inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br ${right.color} rounded-lg mb-4 shadow-lg text-white flex-shrink-0`}>
                    {right.icon}
                  </div>
                  <CardTitle className="text-slate-900 dark:text-white text-base sm:text-lg">{right.title}</CardTitle>
                  <p className="text-slate-600 dark:text-slate-300 text-xs sm:text-sm">{right.description}</p>
                </CardHeader>
                <CardContent className="p-4 sm:p-6 pt-0">
                  <div className="space-y-3">
                    <div className="flex items-center justify-between text-xs sm:text-sm">
                      <span className="text-slate-500 dark:text-slate-400">Response Time:</span>
                      <Badge variant="outline" className="text-xs">{right.timeframe}</Badge>
                    </div>
                    <Button className="w-full bg-gradient-to-r from-blue-600 to-violet-600 hover:from-blue-700 hover:to-violet-700 text-white text-xs sm:text-sm">
                      {right.action}
                    </Button>
                  </div>
                </CardContent>
        ...
        <Card className="glass-strong border-white/30 dark:border-slate-700/50 shadow-2xl mb-8 sm:mb-12 animate-fade-in" style={{animationDelay: '1s'}}>
          <CardHeader className="p-4 sm:p-6">
            <CardTitle className="flex items-center space-x-2 text-slate-900 dark:text-white text-lg sm:text-xl">
              ...
              {dataCategories.map((category, index) => (
                <div key={index} className="border border-slate-200 dark:border-slate-700 rounded-lg p-3 sm:p-4">
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-3 space-y-2 sm:space-y-0">
                    <h3 className="font-semibold text-slate-900 dark:text-white text-sm sm:text-base">{category.category}</h3>
                    <Badge variant="outline" className="self-start text-xs">{category.lawfulBasis}</Badge>
                  </div>
        ...
        <Card className="glass-strong border-white/30 dark:border-slate-700/50 shadow-2xl mb-8 sm:mb-12 animate-fade-in" style={{animationDelay: '1.1s'}}>
          <CardHeader className="p-4 sm:p-6">
            <CardTitle className="flex items-center space-x-2 text-slate-900 dark:text-white text-lg sm:text-xl">
          ...
          <CardContent className="p-4 sm:p-6 pt-0">
            <div className="space-y-4 sm:space-y-6">
              {dataProcessingActivities.map((activity, index) => (
                <div key={index} className="border border-slate-200 dark:border-slate-700 rounded-lg p-3 sm:p-4">
                  <h3 className="font-semibold text-slate-900 dark:text-white mb-2 text-sm sm:text-base">{activity.activity}</h3>
                  <p className="text-slate-600 dark:text-slate-300 text-xs sm:text-sm mb-3">{activity.description}</p>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 text-xs sm:text-sm">
                    <div>
                      <p className="font-medium text-slate-900 dark:text-white mb-1">Data Types:</p>
                    ...
                    <div>
                      <p className="font-medium text-slate-900 dark:text-white mb-1">Recipients:</p>
                      <ul className="text-slate-600 dark:text-slate-300 space-y-1">
                    ...
                    <div className="md:col-span-2 xl:col-span-1">
                      <p className="font-medium text-slate-900 dark:text-white mb-1">Safeguards:</p>
                      <ul className="text-slate-600 dark:text-slate-300 space-y-1">
        ...
        <Card className="glass-strong border-white/30 dark:border-slate-700/50 shadow-2xl mb-8 sm:mb-12 animate-fade-in" style={{animationDelay: '1.2s'}}>
          <CardHeader className="p-4 sm:p-6">
            <CardTitle className="flex items-center space-x-2 text-slate-900 dark:text-white text-lg sm:text-xl">
          ...
          <CardContent className="p-4 sm:p-6 pt-0">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold text-slate-900 dark:text-white mb-3 text-sm sm:text-base">Transfer Safeguards</h3>
                ...
                <ul className="space-y-2 text-xs sm:text-sm text-slate-600 dark:text-slate-300">
                  ...
                  <li className="flex items-start space-x-2">
                    <CheckCircle className="h-4 w-4 text-green-600 mt-0.5 flex-shrink-0" />
                    <span>Certification mechanisms</span>
                  </li>
                </ul>
              </div>
              <div>
                <h3 className="font-semibold text-slate-900 dark:text-white mb-3 text-sm sm:text-base">Transfer Recipients</h3>
                <p className="text-slate-600 dark:text-slate-300 text-xs sm:text-sm mb-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-2 bg-blue-50/50 dark:bg-blue-900/20 rounded">
                    <span className="text-xs sm:text-sm text-slate-600 dark:text-slate-300">United States</span>
                    <Badge variant="outline" className="text-xs">EU-US DPF</Badge>
                  </div>
                  <div className="flex items-center justify-between p-2 bg-green-50/50 dark:bg-green-900/20 rounded">
                    <span className="text-xs sm:text-sm text-slate-600 dark:text-slate-300">United Kingdom</span>
                    <Badge variant="outline" className="text-xs">Adequacy Decision</Badge>
                  </div>
                  <div className="flex items-center justify-between p-2 bg-purple-50/50 dark:bg-purple-900/20 rounded">
                    <span className="text-xs sm:text-sm text-slate-600 dark:text-slate-300">Canada</span>
                    <Badge variant="outline" className="text-xs">Adequacy Decision</Badge>
                  </div>
                </div>
              </div>
          ...
          <Card className="glass-strong border-white/30 dark:border-slate-700/50 shadow-xl animate-fade-in" style={{animationDelay: '1.3s'}}>
            ...
            <CardContent className="p-4 sm:p-6 pt-0">
              ...
              <div className="space-y-2 text-xs sm:text-sm">
                <p className="text-slate-600 dark:text-slate-300">
                  <strong>Email:</strong> dpo@salesspeak.com
                </p>
                <p className="text-slate-600 dark:text-slate-300">
                  <strong>Response Time:</strong> Within 72 hours
                </p>
              </div>
              <Button className="w-full mt-4 bg-gradient-to-r from-blue-600 to-violet-600 hover:from-blue-700 hover:to-violet-700 text-white text-xs sm:text-sm">
        ...
        <Card className="glass-strong border-white/30 dark:border-slate-700/50 shadow-2xl animate-fade-in" style={{animationDelay: '1.5s'}}>
          <CardHeader className="p-4 sm:p-6">
            <CardTitle className="flex items-center space-x-2 text-slate-900 dark:text-white text-lg sm:text-xl">
          ...
          <CardContent className="p-4 sm:p-6 pt-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              <Button className="bg-gradient-to-r from-blue-600 to-violet-600 hover:from-blue-700 hover:to-violet-700 text-white text-xs sm:text-sm">
              ...
              <Button variant="outline" className="sm:col-span-2 lg:col-span-1 text-xs sm:text-sm">
                <Mail className="h-4 w-4 mr-2" />
                Contact Support
              </Button>
            </div>
